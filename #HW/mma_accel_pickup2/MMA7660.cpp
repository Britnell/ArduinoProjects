...
void MMA::init()
{
  ...
  // 4 - GINT
  // 0xE0 - 5,6,7 Shake-X,Y,Z int
  MMA7660_I2C_SEND(0x06, BIT0 | BIT1 | BIT2 | BIT5 | BIT6 | BIT7 );
  ...
  // (x<<5)
  //   0 = disable
  //   1 .. 7 = 2 .. 8 samples must match, debounce
  ...
  //    5-XDA,    6-YDA,      7-ZDA,
  //    All x,y,z = 0xE0
  MMA7660_I2C_SEND(0x09, BIT5 | BIT6 | BIT7 );

  //      # PD Puse Debounce
  //  Tap detection filter requr 2 adjacent tap detects to sei INT
  //    0,1 - 2 adj.
  //    2 - 3 adj 
  //      ...
  //    256 - 256 vals
  MMA7660_I2C_SEND(0x0A, 0x01 );
