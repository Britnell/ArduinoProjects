...
//  _D Serial.println(int(dividend));   
  ...
  moonphase -= MoonTime * int(dividend);
  _D Serial.print(" ....\n So... our moon cycle is : ");
  _D Serial.print(moonphase);   
  _D Serial.print(" days \t");

  moonphase /= MoonTime;
  _D Serial.print("  or as Percentage : ");
  _D Serial.println(moonphase);   
  
  // # Help lines
  /*    A NEW MOON = 0 is blank     
   *    (right) half = 0.25   or 1/4 
   *    Full Moon = 0.5 
   *    Last quarter (left half)  =   0.75 ");
   *    
         **    Moon illumination
