...
//  _D Serial.print(" days after adding together years: ");
//  _D Serial.println(lifetime);   
...
//  _D Serial.print(" days until this year: ");
//  _D Serial.println(lifetime);   
//  _D Serial.print(" + days this year : ");
//  _D Serial.println(daysThisYear);   

//  _D sprintf(buff, "So it has been %d days until beginning of year + %d days this year so far ", lifetime, daysThisYear);
//    _D Serial.print(buff);
  ...
  _D Serial.print(" The most famous New Moon is 7/1/1970.\n Since then it has been   ");
  _D Serial.print(lifetime);   
  _D Serial.print(" sunsets");
  
  double moonphase = 1.0 * (lifetime);
//  _D Serial.print(" Moonphase printout ");
//  _D Serial.println(moonphase);   

  float dividend = moonphase / 29.53;
  _D Serial.print(" That is ");
  _D Serial.print(dividend);   
  _D Serial.print(" Full Moon cycles!");
  
//  _D Serial.print(" as int :  ");
//  _D Serial.println(int(dividend));   
  
  moonphase -= 29.53 * int(dividend);
  _D Serial.print(" \n\n....\n So... our moon cycle is : ");
  _D Serial.print(moonphase);   
  _D Serial.print(" days \n");

  moonphase /= 29.53;
  // # Help lines
  _D Serial.println(" ###################");
  _D Serial.println(" A NEW MOON = 0 is blank\n (right) half = 0.25   or 1/4");
  _D Serial.println("   Full Moon = 0.5 and Last quarter (left half)  =   0.75 ");
  // #
  _D Serial.print(" \n So for the moon as a percentage : ");
  _D Serial.println(moonphase);   
  
  /*      **    Moon illumination
   *   This will mean that  at 
   *   0/1 = back moon    ;   0.25 = RIGHT side
   *   0.5 = FRONT full   ;   0.75 = Left side 
   */
